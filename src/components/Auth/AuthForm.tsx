...
const AuthForm = ({ isOpen, closeModal }: AuthFormProps) => {
  ...
  confirmPassword: "",
    ...
    // const userData = JSON.parse(localStorage.getItem('user') || JSON.stringify(initialState))
...
<button
        ...
        className="bg-blue-600 hover:bg-blue-400 rounded-full text-white"
      >
        Login with Google
      </button>
...
<hr className="border-t border-gray-300 mt-2" />
                      ...
                      <div className='flex-1 flex flex-col gap-2'>
                        ...
                        <h1 className="z-10 relative px-4 bg-white text-gray-500 font-bold text-center uppercase">or</h1>
